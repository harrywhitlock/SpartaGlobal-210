...
def do_battle(pokemon1, pokemon2):
    ...
    while hp_counter_2 > 0 and hp_counter_1 > 0:
        ...
        hp_counter_1 = hp_counter_1 - (pokemon2['attack'] * 0.1) * mult_1
        hp_counter_2 = hp_counter_2 - (pokemon1['attack'] * 0.1) * mult_2
...
def main():
    ...
    if (mode not in ['1', 'one', '2', 'two']): return 0
            ...
            if (mode in ['1', 'one']):
                ...
                while correct_pick != True:
                    try:
                        ...
                        print('That\'s not a valid Pokemon, try again')
            time.sleep(0.5)
